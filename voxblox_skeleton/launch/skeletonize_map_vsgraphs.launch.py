...
def generate_launch_description():
    ...
    pc_topic_arg = DeclareLaunchArgument(
        "pc_topic", default_value="/vs_graphs/points_map",
    ...
    skeletonizer_node = Node(
        ...
        parameters=[{
            ...
            "max_block_distance_from_body": 100,
